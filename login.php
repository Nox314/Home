    ...
    <div class="card">
        ...
        <form method="post" action="">
            ...
            <div class="checkbox-group">
                ...
                <label for="remember"><?php echo t('welcome_user') !== t('welcome') ? (strpos(t('welcome_user'), 'User') !== false ? 'Angemeldet bleiben' : '') : 'Angemeldet bleiben'; ?></label>
            </div>
            <button type="submit"><?php echo $lang === 'de' ? 'Anmelden' : 'Login'; ?></button>
        </form>
        <div class="links"><a href="/register/"><?php echo $lang === 'de' ? 'Noch kein Konto? Registrieren' : 'No account? Register'; ?></a></div>
    </div>
</body>
</html>
